...
export const Project:React.FC<Project> = ({title, description,href, target,...rest}) => {

    return (
        <a href={href} target={target} className="lg:h-full w-full overflow-hidden group rounded-lg border-2 border-white relative cursor-pointer block  h-[200px] ">
